...
class Calculator extends React.Component {
  ...
  handleNumbers(e) {
    ...
    // Flash warning if user input for single value or whole expression too long
      ...
      String(this.state.currentValue).replace(/[^0-9]/g, "").length >=
        MaxSignificantDigits ||
      String(this.state.currentValue).length +
        String(this.state.currentFormula).length >=
        MaxFormulaLength
    ) {
    ...
    // Ignore input if current value is invalid (exponential, infinite, NaN)
      ...
      String(this.state.currentValue).indexOf("e") === -1 &&
  ...
  handleDecimal(e) {
    ...
    // Ignore input if current value is invalid (exponential, infinite, NaN)
      ...
      this.setState({
        ...
        currentValue: /\./g.test(this.state.currentValue)
  ...
  handleSecondaryOperators(e) {
    ...
    if (
      this.state.currentValue !== "" &&
      this.evaluateMath(this.state.currentValue) !== 0
    ) {
      if (e.target.value === "±") {
        this.setState({
  ...
  handleEquals(e) {
    ...
    if (
      !/=/g.test(this.state.currentFormula) &&
      this.state.currentValue !== ""
    ) {
      ...
      String(this.state.currentValue)[0] === "-"
        ? (formula =
            this.state.currentFormula + "(" + this.state.currentValue + ")")
  ...
  render() {
    ...
    return (
      <div className="calculator">
        <Screen currentFormula={displayFormula} currentValue={displayValue} />
        <Buttons
  ...
  render() {
    return (
      <div className="title-bar-buttons">
        <div id="red-button" className="title-bar-button" />
        <div id="yellow-button" className="title-bar-button" />
        <div id="green-button" className="title-bar-button" />
      </div>
    );
  }
}
...
class Button extends React.Component {
  ...
  render() {
    ...
    if (display === "AC" && this.props.currentValue !== "") {
      display = "C";
    }
    return (
      <button
